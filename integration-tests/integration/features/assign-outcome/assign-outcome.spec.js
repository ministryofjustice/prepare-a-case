/* global cy expect When And */

And('I should {string} the modal popup to assign hearing outcome', ($expected) => {
...
And('the modal popup should have text heading {string}', ($pContent) => {

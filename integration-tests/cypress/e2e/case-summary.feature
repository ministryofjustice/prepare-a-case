...
Scenario: Move a case to resulted
  ...
  Then I should be on the "Hearing outcomes" page
  # And i should be navigated back to the case list page
  # And i should see a banner

# Scenario: Move a case to resulted is disabled
#   Given I am an authenticated user

#   When I navigate to the "cases" route
#   Then I should be on the "Case list" page
#   # click a case that is not in progress

#   And I should see a button with the label "Actions"
#   And I click the "Actions" button
#   And I should see an MOJ menu button with the label "Move to resulted disabled"

...
const pagedCaseListRouteHandler = require('./getPagedCaseListRouteHandler')({ getPagedCaseList, isFeatureEnabled }, { getPreferences, updatePreferences, getFilters, setFilters })

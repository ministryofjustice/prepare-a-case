...
const { getOutcomesList, assignHearingOutcome, updateHearingOutcomeToResulted, getCase, toggleHearingOutcomeRequired } = require('../../../services/case-service')
...
const getToggleHearingOutcomeRequiredHandler = require('./getToggleHearingOutcomeRequiredHandler')({ toggleHearingOutcomeRequired })
...
outcomesRouter.get('/hearing/:hearingId/defendant/:defendantId/toggle-hearing-outcome-required', defaults, catchErrors(getToggleHearingOutcomeRequiredHandler))

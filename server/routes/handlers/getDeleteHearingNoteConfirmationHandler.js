const getDeleteHearingNoteConfirmationHandler = (getCaseAndTemplateValues) => async (req, res) => {
  ...
  res.render('confirm-delete-hearing-note', {
    ...templateValues,
    ...note,
    targetHearingId,
...
module.exports = getDeleteHearingNoteConfirmationHandler

...
const manageCourtByStateGetHandler = require('../../../../server/routes/manage-courts/handlers/manageCourtByStateGet')
const { settings } = require('../../../../server/config')

describe('manageCourtsByState GET Handler', () => {
    ...
    const subject = manageCourtByStateGetHandler(testBasePath, updateSelectedCourtsMock)
    const subjectWithFailingUpdate = manageCourtByStateGetHandler(testBasePath, updateSelectedCourtsMockFailing)

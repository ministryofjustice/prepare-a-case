...
describe('getAutoSaveHearingNoteEditsHandler', () => {
  ...
  const subject = require('../../../server/routes/handlers/getAutoSaveHearingNoteEditsHandler')(caseServiceMock)
  ...
  it('should invoke save draft note and return response', async () => {
    caseServiceMock.updateHearingNote.mockResolvedValueOnce({ data: { note: 'note' }, status: 200 })
    // When

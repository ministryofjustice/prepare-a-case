...
* You have Node.js [LTS](https://nodejs.org/en/about/releases/) (Fermium) >= v14.18.1
...
```
java -jar wiremock-jre8-standalone-2.31.0.jar --global-response-templating --port 9091
```

...
* You have Node.js [LTS](https://nodejs.org/en/about/releases/) (Dubnium) >= v16.15.0
...
```
java -jar wiremock-jre8-standalone-2.33.2.jar --global-response-templating --port 9091
```
